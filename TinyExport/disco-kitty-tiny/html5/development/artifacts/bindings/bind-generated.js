...
entities.game.Ent_circleGame = entities.game.Ent_circleGame || {};
entities.game.Ent_circleGame.Component = function() {
};
entities.game.Ent_circleGame.Component.prototype = Object.create(null);
entities.game.Ent_circleGame.Component.prototype.constructor = entities.game.Ent_circleGame.Component;
Object.defineProperties(entities.game.Ent_circleGame.Component.prototype, {
});
entities.game.Ent_circleGame.Component._size = 1;
entities.game.Ent_circleGame.Component._fromPtr = function(ptr, v) {
  v = v || Object.create(entities.game.Ent_circleGame.Component.prototype);
  return v;
};
entities.game.Ent_circleGame.Component._toPtr = function(ptr, v) {
};
entities.game.Ent_circleGame.Component._toTempHeapPtr = function(ptr, v) {
};
entities.game.Ent_circleGame.Component._tempHeapPtr = function(v) {
  var ptr = ut.tempHeapPtrBufferZero(1);
  if (v) entities.game.Ent_circleGame.Component._toTempHeapPtr(ptr, v);
  return ptr;
};
entities.game.Ent_circleGame.Component.StorageView = function(ptr) {
  this._ptr = ptr;
};
entities.game.Ent_circleGame.Component.StorageView.prototype = Object.create(null);
entities.game.Ent_circleGame.Component.StorageView.prototype.constructor = entities.game.Ent_circleGame.Component.StorageView;
entities.game.Ent_circleGame.Component._view = entities.game.Ent_circleGame.Component.StorageView;
entities.game.Ent_circleGame.Component.StorageView._isSharedComp = entities.game.Ent_circleGame.Component._isSharedComp = false;
entities.game.Ent_circleGame.Component.StorageView._fromPtr = entities.game.Ent_circleGame.Component._fromPtr;
entities.game.Ent_circleGame.Component.StorageView._toPtr = entities.game.Ent_circleGame.Component._toPtr;
entities.game.Ent_circleGame.Component.StorageView._tempHeapPtr = entities.game.Ent_circleGame.Component._tempHeapPtr;
entities.game.Ent_circleGame.Component.StorageView._size = entities.game.Ent_circleGame.Component._size;
entities.game.Ent_circleGame.Component.StorageView.prototype.$advance = function() {
  this._ptr += 1;
};
Object.defineProperties(entities.game.Ent_circleGame.Component.StorageView.prototype, {
});
entities.game.Ent_circleGame.Component._dtorFn = function dtor(ptr) { /* POD, no-op */ }
// entities.game.Ent_circleGame.Component is a POD type, so a JavaScript side copy constructor entities.game.Ent_circleGame.Component._copyFn = function copy(src, dst) { ... } does not need to be generated for it
entities.game.Ent_circleGame.Component._typeDesc = (function() {
  return ut.meta.allocType(5, 'entities.game.Ent_circleGame.Component', 1, []);
})();
Object.defineProperties(entities.game.Ent_circleGame.Component, { cid: { configurable: true, get: function() { delete entities.game.Ent_circleGame.Component.cid; var offsetsPtr = 0, offsetsCount = 0; return entities.game.Ent_circleGame.Component.cid = Module._ut_component_register_cid_with_type(entities.game.Ent_circleGame.Component._typeDesc, 0, 0, offsetsPtr, offsetsCount, 0, 0); } } });
Object.defineProperties(entities.game.Ent_circleGame.Component.StorageView, { cid: { configurable: true, get: function() { return entities.game.Ent_circleGame.Component.cid; } } });
var game = game || {};
game.moveToPointerComponent = function(arg0) {
  this._moveSpeed = (+(arg0===undefined ? 0 : arg0));
};
game.moveToPointerComponent.prototype = Object.create(null);
game.moveToPointerComponent.prototype.constructor = game.moveToPointerComponent;
Object.defineProperties(game.moveToPointerComponent.prototype, {
  moveSpeed: {
    get: function() { return this._moveSpeed; },
    set: function(v) { this._moveSpeed = (+(v===undefined ? 0 : v)); },
  },
});
game.moveToPointerComponent._size = 4;
game.moveToPointerComponent._fromPtr = function(ptr, v) {
  v = v || Object.create(game.moveToPointerComponent.prototype);
  v._moveSpeed = HEAPF32[(ptr+0)>>2];
  return v;
};
game.moveToPointerComponent._toPtr = function(ptr, v) {
  HEAPF32[(ptr+0)>>2] = v.moveSpeed;
};
game.moveToPointerComponent._toTempHeapPtr = function(ptr, v) {
  HEAPF32[(ptr+0)>>2] = v.moveSpeed;
};
game.moveToPointerComponent._tempHeapPtr = function(v) {
  var ptr = ut.tempHeapPtrBufferZero(4);
  if (v) game.moveToPointerComponent._toTempHeapPtr(ptr, v);
  return ptr;
};
game.moveToPointerComponent.StorageView = function(ptr) {
  this._ptr = ptr;
};
game.moveToPointerComponent.StorageView.prototype = Object.create(null);
game.moveToPointerComponent.StorageView.prototype.constructor = game.moveToPointerComponent.StorageView;
game.moveToPointerComponent._view = game.moveToPointerComponent.StorageView;
game.moveToPointerComponent.StorageView._isSharedComp = game.moveToPointerComponent._isSharedComp = false;
game.moveToPointerComponent.StorageView._fromPtr = game.moveToPointerComponent._fromPtr;
game.moveToPointerComponent.StorageView._toPtr = game.moveToPointerComponent._toPtr;
game.moveToPointerComponent.StorageView._tempHeapPtr = game.moveToPointerComponent._tempHeapPtr;
game.moveToPointerComponent.StorageView._size = game.moveToPointerComponent._size;
game.moveToPointerComponent.StorageView.prototype.$advance = function() {
  this._ptr += 4;
};
Object.defineProperties(game.moveToPointerComponent.StorageView.prototype, {
  moveSpeed: {
    get: function() { return HEAPF32[(this._ptr+0)>>2]; },
    set: function(v) { HEAPF32[(this._ptr+0)>>2] = v; },
  },
});
game.moveToPointerComponent._dtorFn = function dtor(ptr) { /* POD, no-op */ }
// game.moveToPointerComponent is a POD type, so a JavaScript side copy constructor game.moveToPointerComponent._copyFn = function copy(src, dst) { ... } does not need to be generated for it
game.moveToPointerComponent._typeDesc = (function() {
  return ut.meta.allocType(5, 'game.moveToPointerComponent', 4, [
    {name: 'moveSpeed', offset: 0, type: ut.meta.getType('float')}
  ]);
})();
Object.defineProperties(game.moveToPointerComponent, { cid: { configurable: true, get: function() { delete game.moveToPointerComponent.cid; var offsetsPtr = 0, offsetsCount = 0; return game.moveToPointerComponent.cid = Module._ut_component_register_cid_with_type(game.moveToPointerComponent._typeDesc, 4, 0, offsetsPtr, offsetsCount, 0, 0); } } });
Object.defineProperties(game.moveToPointerComponent.StorageView, { cid: { configurable: true, get: function() { return game.moveToPointerComponent.cid; } } });
game.moveToPointerComponent.moveSpeed = { $ofs:0, $t:"float", $c:game.moveToPointerComponent };
var ut = ut || {};
ut.Core2D = ut.Core2D || {};
...
game.moveToPointerSystemJS = ut.System.define({
  name: "game.moveToPointerSystemJS"
});
