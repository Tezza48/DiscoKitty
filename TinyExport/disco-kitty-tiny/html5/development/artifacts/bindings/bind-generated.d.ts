declare namespace entities.game.Ent_circleGame {
...
class moveToPointerComponent extends ut.Component {
  ...
  static _size: number;
  static _fromPtr(p: number, v?: moveToPointerComponent): moveToPointerComponent;
  static _toPtr(p: number, v: moveToPointerComponent): void;
  static _tempHeapPtr(v: moveToPointerComponent): number;
  static _dtorFn(v: moveToPointerComponent): void;
}
...
declare namespace game {
var moveToPointerSystemJS: ut.SystemJS;
}
